            ...
            <div class="navbar-header" data-logobg="skin5">
                ...
                <a class="navbar-brand" href="index.html">
                    ...
                    <b class="logo-icon p-l-10">
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{asset('admin_template/assets/images/logo-icon.png')}}" alt="homepage" class="light-logo" />
                    ...
                    <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{asset('admin_template/assets/images/logo-text.png')}}" alt="homepage" class="light-logo" />
